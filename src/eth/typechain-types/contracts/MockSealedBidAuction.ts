...
export interface MockSealedBidAuctionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "auctionCount"
      | "auctions"
  ...
  encodeFunctionData(
    functionFragment: "getBidHash",
    values: [BigNumberish, AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "getRevealedBid",
    values: [BigNumberish, AddressLike]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "getBidHash", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getRevealedBid",
    data: BytesLike
  ): Result;
...
export interface MockSealedBidAuction extends BaseContract {
  connect(runner?: ContractRunner | null): MockSealedBidAuction;
  waitForDeployment(): Promise<this>;

  interface: MockSealedBidAuctionInterface;
  ...
  getBidHash: TypedContractMethod<
    [auctionId: BigNumberish, bidder: AddressLike],
    [string],
    "view"
  >;

  getRevealedBid: TypedContractMethod<
    [auctionId: BigNumberish, bidder: AddressLike],
    [bigint],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getRevealedBid"
  ): TypedContractMethod<
    [auctionId: BigNumberish, bidder: AddressLike],
    [bigint],
    "view"
